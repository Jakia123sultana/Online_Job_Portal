      ...
      <div className="flex gap-16 mt-10">
        <div className="bg-gray-900 p-6 rounded-lg w-[80%]">
          ...
          <form className="space-y-4" onSubmit={handlePostComment}>
            ...
            <button className="bg-cyan-600 hover:bg-cyan-700 text-white px-5 py-2 rounded transition">POST COMMENT</button>
          </form>
...
<div className="w-[42%]"> 
  <h3 className="text-2xl font-bold text-white mb-4">Related Jobs</h3>
   <div className="grid grid-cols-2 gap-5"> 
    <img src="https://i.ibb.co.com/wrLzHRkt/datawork.jpg" alt="Team 1" className="w-full h-54 object-cover" /> 
    <img src="https://i.ibb.co.com/JwhF5SQR/team.jpg" alt="Team 2" className="w-full h-44 object-cover" /> 
    <img src="https://i.ibb.co.com/ccrKKQ7p/ux-ui.webp" alt="Team 3" className="w-full h-44 object-cover" />
     <img src="https://i.ibb.co.com/S4bCK9LY/netflex.jpg" alt="Team 4" className="w-full h-66 object-cover" /> 
     </div> 
     </div>
        {/* Related Jobs remains unchanged */}
      </div>
    </div>
  );
};
